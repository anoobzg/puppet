...
bool GraphicsWindowWin32::setWindowDecorationImplementation( bool decorated )
{
    ...
    if (!::SetWindowPos(_hwnd, HWND_TOP, x, y, w, h, SWP_ASYNCWINDOWPOS | SWP_FRAMECHANGED | SWP_NOZORDER | SWP_SHOWWINDOW))
    {
...
bool GraphicsWindowWin32::setWindowRectangleImplementation(int x, int y, int width, int height)
{
    ...
    if (!::SetWindowPos(_hwnd, HWND_TOP, wx, wy, ww, wh, SWP_ASYNCWINDOWPOS | SWP_SHOWWINDOW | SWP_FRAMECHANGED))
    {
