...
const char* OpenThreadsGetVersion()
{
    ...
    {
        sprintf_s(OpenThreads_version,"%d.%d.%d",OPENTHREADS_MAJOR_VERSION,OPENTHREADS_MINOR_VERSION,OPENTHREADS_PATCH_VERSION);
...
const char* OpenThreadsGetSOVersion()
{
    ...
    {
        sprintf_s(OpenThreads_soversion,"%d",OPENTHREADS_SOVERSION);
