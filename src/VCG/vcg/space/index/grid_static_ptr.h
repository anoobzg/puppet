...
public:
	...
	Definition Link within the grid. Class support for GridStaticObj. 
	*/
	class Link
	{
	public:
	...
	std::vector<Link>   links;   /// Set of all the links

	std::vector<Cell> grid;   /// Grid veritable



	bool Empty() const {return links.empty();}

	/// Given the coordinates of a grid point (corner minx, mit, minz) returns the cells 
	/// that share the edge cell that starts from the grid point in the direction of axis
